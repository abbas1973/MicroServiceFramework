...
namespace Utilities.Files
{
    public static class FileUrlExtension
    {
        ...
        private const string DOWNLOAD_URL_BY_ID = "/Api/v1/MediaFiles/Download/{0}?IsThumb={1}";
        private const string STREAM_URL_BY_ID = "/Api/v1/MediaFiles/GetStream/{0}?IsThumb={1}";
